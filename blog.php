    ...
    <div class="blog-wrap pt-150 pb-150">
        <div class="container">
            <div class="title-wrap pb-30">
                <h2 class="text-36" data-gsap="fadeUp">Recent blog posts</h2>
            </div>
            <div class="ul-list">
                <ul>
                    <li>
                        <div class="box box--blog brd-20" data-gsap="fadeUp">
                            ...
                            <div class="info text-xs">
                                <h3 class="h4"><a href="#">Aliquet pulvinar sollicitudin
                                        sit hac ultrices praesent</a></h3>
                                <p>Convallis ultricies ipsum phasellus urna erat. Sagittis integer pellentesque.</p>
                                <div class="author">
